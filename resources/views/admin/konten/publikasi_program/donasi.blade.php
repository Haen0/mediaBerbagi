    ...
    <div class=" p-5 flex justify-between">
        ...
        <div class="flex gap-1">
            <div class="flex items-center justify-center text-center bg-white rounded-md my-auto px-8 h-10 hover:bg-green-50">
                <a href="{{ route('campaign.create') }}" class="text-green-700">Buat Campaign</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="flex flex-col p-5">
            <div class="flex justify-between">
                ...
                <div class="flex items-start px-4 pt-4">
                    ...
                    <!-- Dropdown menu -->
                    <div id="dropdown-{{ $campaign->title }}" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                        <ul class="py-2" aria-labelledby="dropdownButton-{{ $campaign->title }}">
                        <li>
            ...
            <h5 class="text-md font-medium text-gray-900 dark:text-white">{{ $campaign->title }}</h5>
            <span class="mb-3 text-sm text-gray-500 dark:text-gray-400">{{ $campaign->category }}</span>
            <div class="flex text-sm font-medium text-gray-900 dark:text-white">
            ...
            <div class="flex items-center mt-4 md:mt-6">
                <a href="{{ route('campaign.show', $campaign->id) }}" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Preview</a>
            </div>
        </div>
    </div>
    @endforeach
